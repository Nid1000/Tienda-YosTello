                        ...
                        <div class="product-copy">
                            ...
                            <div class="product-meta">
                                <div class="price-stack">
                                    <strong>S/. <?php echo e(number_format($product->final_price, 2, '.', ',')); ?></strong>
                                    <?php if($product->has_discount): ?>
                                        <span class="price-old">S/. <?php echo e(number_format($product->price, 2, '.', ',')); ?></span>
                                        <span class="discount-badge">-<?php echo e(rtrim(rtrim(number_format($product->discount_percent, 2, '.', ''), '0'), '.')); ?>%</span>
                                    <?php endif; ?>
                                </div>
                                <a href="<?php echo e(route('products.show', $product)); ?>">Ver detalle</a>
                            </div>
                        </div>
                    </article>
