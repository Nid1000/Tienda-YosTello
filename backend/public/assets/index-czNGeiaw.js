        ...
        <main>
            ...
            <section class="editorial-section backend-strip">
                <div class="section-copy">
                    ...
                    <h2>Catalogo, colecciones y disponibilidad</h2>
                    <p>Consulta productos, categorias y stock disponible en tiempo real para comprar con seguridad.</p>
                </div>
...
`;const S=document.querySelector("#overlay"),W=document.querySelector("#contact-visual"),X=document.querySelector("#menu-visual"),Z=document.querySelector("#account-visual"),y=document.querySelector("#category-grid"),C=document.querySelector("#backend-stats"),g=document.querySelector("#featured-grid"),q=document.querySelector("#promotions-grid"),m=document.querySelector("#latest-grid"),K=document.querySelector("#bag-count"),$=document.querySelector("#bag-content"),z=document.querySelector("#bag-heading"),H=document.querySelector("#search-input"),k=document.querySelector("#search-results"),v=document.querySelector("#product-detail"),Q=document.querySelector("#cart-dialog-body"),o={products:[],cart:JSON.parse(localStorage.getItem("yotello-cart")||"[]"),selectedSize:"M / 40",activeProductId:null};o.cart=(Array.isArray(o.cart)?o.cart:[]).map(a=>({...a,size:(a==null?void 0:a.size)||"M / 40"}));const n=a=>new Intl.NumberFormat("es-CO",{style:"currency",currency:"COP",maximumFractionDigits:0}).format(a||0),N=()=>localStorage.setItem("yotello-cart",JSON.stringify(o.cart)),aa=a=>{o.cart=o.cart.filter(e=>e.id!==a),N(),p()},ea=(a,e)=>{if(!o.cart.length){window.open(e,"_blank","noopener,noreferrer");return}const t=document.createElement("form");t.method="POST",t.action=`${r}/bridge/cart`,t.target="_blank",t.style.display="none";const c=document.createElement("input");c.type="hidden",c.name="target",c.value=a;const s=document.createElement("input");s.type="hidden",s.name="cart",s.value=JSON.stringify(o.cart.map(i=>({id:i.id,qty:i.qty,size:i.size||o.selectedSize}))),t.appendChild(c),t.appendChild(s),document.body.appendChild(t),t.submit(),t.remove()},u=a=>{var e;document.querySelectorAll(".contact-panel, .account-panel, .menu-panel, .search-panel, .product-panel, .bag-view, .size-panel, .cart-dialog").forEach(t=>t.classList.add("hidden")),S.classList.remove("hidden"),(e=document.querySelector(`#${a}-panel, #${a}`))==null||e.classList.remove("hidden")},f=()=>{document.querySelectorAll(".contact-panel, .account-panel, .menu-panel, .search-panel, .product-panel, .bag-view, .size-panel, .cart-dialog").forEach(a=>a.classList.add("hidden")),S.classList.add("hidden")},D=a=>{var c;const e=o.products.find(s=>s.id===a);if(!e)return;o.activeProductId=a;const t=o.products.filter(s=>s.category===e.category).slice(0,4);v.innerHTML=`
    ...
    `,u("cart-dialog")},sa=a=>{const e=o.products.find(c=>c.id===a);if(!e)return;const t=o.cart.find(c=>c.id===a);t?(t.qty+=1,t.size=t.size||o.selectedSize):o.cart.push({id:e.id,name:e.name,category:e.category,image:e.image,final_price:e.final_price??e.price,qty:1,size:o.selectedSize}),N(),p(),ta(e)},p=()=>{const a=o.cart.reduce((e,t)=>e+t.qty,0);if(K.textContent=String(a),o.cart.length===0)z.textContent="Su bolsa de compra esta actualmente vacia",$.innerHTML=`
        ...
        `;else{const e=o.cart.reduce((t,c)=>t+c.final_price*c.qty,0);z.textContent=`Tiene ${a} articulo${a===1?"":"s"} en su bolsa`,$.innerHTML=`
